...
func (t *ChainCode) Publish(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *ChainCode) Check(stub shim.ChaincodeStubInterface, args []string) pb.Response {
